<x-app-layout :assets="$assets ?? []">
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-01"
                                        class="circle-progress circle-progress-primary text-center" data-min-value="0"
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="total-sales-value" class="counter" style="visibility: visible;">$5160K
                                        </h4>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-02"
                                        class="circle-progress circle-progress-info text-center" data-min-value="0"
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="total-profit-value" class="counter">$185K</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-03"
                                        class="circle-progress circle-progress-primary text-center" data-min-value="0"
                                        data-max-value="100" data-value="70" data-type="percent">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="total-cost-value" class="counter">$375K</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-04"
                                        class="circle-progress circle-progress-info text-center" data-min-value="0"
                                        data-max-value="100" data-value="60" data-type="percent">
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="revenue-value" class="counter">$742K</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-05"
                                        class="circle-progress circle-progress-primary text-center" data-min-value="0"
                                        data-max-value="100" data-value="50" data-type="percent">
                                        <svg class="card-slie-arrow" width="24px" height="24px" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z" />
                                        </svg>
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="net-income-value" class="counter">$150K</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-06"
                                        class="circle-progress circle-progress-info text-center" data-min-value="0"
                                        data-max-value="100" data-value="40" data-type="percent">
                                        <svg class="card-slie-arrow" width="24" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                                        </svg>
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="today-value" class="counter">$4600</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
                            ...
                            <div class="card-body">
                                <div class="progress-widget">
                                    <div id="circle-progress-07"
                                        class="circle-progress circle-progress-primary text-center" data-min-value="0"
                                        data-max-value="100" data-value="30" data-type="percent">
                                        <svg class="card-slie-arrow" width="24" viewBox="0 0 24 24">
                                            <path fill="currentColor"
                                                d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z" />
                                        </svg>
                                    ...
                                    <div class="progress-detail">
                                        ...
                                        <h4 id="members-value" class="counter">11.2M</h4>
                                    </div>
                                </div>
                            </div>
                        </li>
    ...
    <script>
        // Function to convert the sales/profit/cost string from the <h4> (e.g. "$560K") into a numerical value
        function parseSalesValue(valueStr) {
            // Remove any special characters and parse the number
            let value = valueStr.replace(/[^0-9.]/g, '');

            // Check if the value contains K (thousands) or M (millions) and multiply accordingly
        ...
        // Function to calculate percentage based on the value and maximum value
        function calculateProgress(value, maxValue) {
            return (value / maxValue) * 100;
        }

        // Function to update progress circles
        function updateProgressCircle(circleId, totalValueId, maxValue) {
            const totalValueElement = document.getElementById(totalValueId);
            const circleElement = document.getElementById(circleId);

            // Extract the value from the <h4> element
            const totalValueStr = totalValueElement.innerText;
            const totalValue = parseSalesValue(totalValueStr);

            // Calculate the percentage for the progress circle
            const progressValue = calculateProgress(totalValue, maxValue);

            // Update the data-value attribute of the progress circle
            circleElement.setAttribute('data-value', progressValue);
        }

        // Function to initialize the progress circles
        function initializeProgressCircles() {
            // Define the maximum values for each metric
            const maxValues = {
                'total-sales-value': 1000000, // Example max for total sales
                'total-profit-value': 200000, // Example max for total profit
                'total-cost-value': 400000, // Example max for total cost
                'revenue-value': 800000, // Example max for revenue
                'net-income-value': 300000, // Example max for net income
                'today-value': 5000, // Example max for today's value
                'members-value': 12000000 // Example max for members
            };

            // Update progress circles based on their respective max values
            updateProgressCircle('circle-progress-01', 'total-sales-value', maxValues['total-sales-value']);
            updateProgressCircle('circle-progress-02', 'total-profit-value', maxValues['total-profit-value']);
            updateProgressCircle('circle-progress-03', 'total-cost-value', maxValues['total-cost-value']);
            updateProgressCircle('circle-progress-04', 'revenue-value', maxValues['revenue-value']);
            updateProgressCircle('circle-progress-05', 'net-income-value', maxValues['net-income-value']);
            updateProgressCircle('circle-progress-06', 'today-value', maxValues['today-value']);
            updateProgressCircle('circle-progress-07', 'members-value', maxValues['members-value']);
        }
